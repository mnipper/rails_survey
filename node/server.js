...
var fs = require('fs');
var options = {
	    key:    fs.readFileSync(__dirname + '../../../../../../etc/httpd/conf/ssl.key/wci-chpir_duke_edu-private.key'),
	    cert:   fs.readFileSync(__dirname + '../../../../../../etc/httpd/conf/ssl.crt/wci-chpir_duke_edu.cer')
	};
