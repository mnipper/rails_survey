...
namespace :deploy do
  ...
  task :restart do
    ...
    on roles(:app), in: :sequence, wait: 5 do
      execute "sudo cp /etc/httpd/conf/ssl.crt/wci-chpir_duke_edu.cer #{release_path}/node && sudo cp /etc/httpd/conf/ssl.key/wci-chpir_duke_edu-private.key #{release_path}/node"
